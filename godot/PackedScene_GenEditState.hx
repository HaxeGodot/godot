...
@:native("Godot.PackedScene.GenEditState")
@:csNative
extern enum PackedScene_GenEditState {
	/**		
	...
	**/
	...
	/**		
		If passed to `godot.PackedScene.instance`, provides local scene resources to the local scene.
