...
extern class PathFollow extends godot.Spatial {
	/**		
	...
	**/
	...
	/**		
		Allows or forbids rotation on one or more axes, depending on the `godot.PathFollow_RotationModeEnum` constants being used.
	**/
	@:native("RotationMode")
	public var rotationMode:godot.PathFollow_RotationModeEnum;
	...
	**/
	...
	public function setRotationMode(rotationMode:godot.PathFollow_RotationModeEnum):Void;

	@:native("GetRotationMode")
	public function getRotationMode():godot.PathFollow_RotationModeEnum;
