...
@:native("Godot.Light.Param")
@:csNative
extern enum Light_Param {
	/**		
		Constant for accessing `godot.Light.lightEnergy`.
	**/
	Energy;

	/**		
		Constant for accessing `godot.Light.lightIndirectEnergy`.
	**/
	IndirectEnergy;
	...
	**/
	...
	/**		
		Constant for accessing `godot.Light.shadowContact`.
	**/
	ContactShadowSize;
	...
	**/
	...
	/**		
		Constant for accessing `godot.Light.shadowBias`.
	**/
	ShadowBias;
	...
	**/
	...
	/**		
		Represents the size of the `godot.Light_Param` enum.
	**/
	Max;
}
