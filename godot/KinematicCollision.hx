...
extern class KinematicCollision extends godot.Reference {
	...
	**/
	...
	/**		
		The colliding body's `godot.RID` used by the `godot.PhysicsServer`.
	**/
	@:native("ColliderRid")
	...
	**/
	@:native("GetAngle")
	public function getAngle(?upDirection:Null<godot.Vector3>):Single;
	#else
	/**		
		The collision angle according to `up_direction`, which is `Vector3.UP` by default. This value is always positive.
	...
	**/
	@:native("GetAngle")
	public overload function getAngle(upDirection:Nullable1<godot.Vector3>):Single;
	#end
